...
microcode: Final[list[isa.MInstruction]] = _with_labels(lambda label: [
    "instruction_fetch",
    ...
    *_load_rri,
    ...
    "BLEQ",
    *_load_rri,
    MIJump(x_sel=isa.OR1, y_sel=isa.OR2, alu_ctrl=isa.ALUControl.sub, if_carry=label("BLEQ_jmp"), if_zero=label("BLEQ_jmp")),
    MIJump(to=label("increment_pc")),
    "BLEQ_jmp",
    MIOperation(x_sel=isa.OR3, rwr_sel=isa.PC),
    MIJump(to=label("instruction_fetch")),
